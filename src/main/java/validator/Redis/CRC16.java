...
public class CRC16 
{
    ...
    /**
     * Create a CRC16 checksum from the int.
     *
     * @param key input integer
     * @return CRC16 as integer value
     */
    public static int crc16(int key) {
        return crc16(intToBytes(key));
    }

    /**
     * Convert integer to array of bytes.
     *
     * @param num the input integer number
     * @return the integer value as a byte array
     */
